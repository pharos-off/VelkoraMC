...
const LauncherVersion = {
  ...
  name: 'Velkora Client',
  version: '4.7.1', // Format: MAJOR.MINOR.PATCH
  versionName: '4.7.1', // Format: Nom de la version
  build: '20260910', // Format: YYYYMMDD
  releaseDate: '2026-09-10', // Format: YYYY-MM-DD
